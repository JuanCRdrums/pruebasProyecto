  <?php
    ...
    if(isset($_POST["submit"]))
    {
      ...
      $SQL = "SELECT * FROM empresas WHERE (Direccion LIKE '%$DireccionX%')";
...
<body>
  <div class="container">
    <br>
    <br><br><br>
    <h1>Consulta de empresas por dirección</h1>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top bg-inverse">
    ...
    <form class="form-horizontal" role = "form" method="post" action="empresaPorDireccion.php">
      <div class="form-group">
        <label for="DireccionX" class="col-sm-2 control-label">Dirección: </label>
        <div class="col-sm-10">
          <textarea class="from-control" id="DireccionX" name="DireccionX" placeholder="Direccion a consultar"></textarea>
        </div>
      </div>
