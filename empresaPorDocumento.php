...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top bg-inverse">
    ...
    <form class="form-horizontal" role = "form" method="post" action="empresaPorDocumento.php">
      <div class="form-group">
        <label for="DocumentoX" class="col-sm-2 control-label">Documento: </label>
        <div class="col-sm-10">
          <textarea class="from-control" id="DocumentoX" name="DocumentoX" placeholder="Documento a consultar"></textarea>
        </div>
      </div>
