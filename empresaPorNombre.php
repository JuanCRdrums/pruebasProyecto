  <?php
    ...
    if(isset($_POST["submit"]))
    {
      ...
      $SQL = "SELECT * FROM empresas WHERE (RazonSocial LIKE '%$NombreX%')";
...
<body>
  <div class="container">
    <br>
    <br>
    <h1>Consulta de empresas por nombre comercial</h1>
  <nav class="navbar navbar-inverse navbar-fixed-top bg-inverse">
    ...
    <form class="form-horizontal" role = "form" method="post" action="empresaPorNombre.php">
      <div class="form-group">
        <label for="NombreX" class="col-sm-2 control-label">Nombre comercial: </label>
        <div class="col-sm-10">
          <textarea class="from-control" id="NombreX" name="NombreX" placeholder="Nombre comercial a consultar"></textarea>
        </div>
      </div>
