  <?php
    ...
    {
      $CiudadX = $_POST["CiudadX"];
      $SQL = "SELECT * FROM empresas WHERE (Ciudad LIKE '%$CiudadX%')";
...
<body>
  <div class="container">
    <br>
    <br>
    <h1>Consulta de empresas por ciudad</h1>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top bg-inverse">
    ...
    <form class="form-horizontal" role = "form" method="post" action="empresaPorCiudad.php">
      <div class="form-group">
        <label for="CiudadX" class="col-sm-2 control-label">Ciudad: </label>
        <div class="col-sm-10">
          <textarea class="from-control" id="CiudadX" name="CiudadX" placeholder="Ciudad a consultar"></textarea>
        </div>
      </div>
